...
Copy the provided overlay file `k3-am67a-beagley-ai-spidev0-mcu.dtso` into the `src/arm64/overlays/` directory of your copy of the device-tree source.
